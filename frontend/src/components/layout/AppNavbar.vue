        ...
        <div class="flex items-center gap-2">
          ...
          <template v-if="authStore.isAuthenticated">
            ...
            <div class="relative" ref="notifDropdownRef">
              ...
              >
                <div v-if="notifOpen" class="absolute right-0 mt-3 w-[calc(100vw-2rem)] sm:w-96 max-w-sm rounded-2xl bg-white dark:bg-dark-800 shadow-xl shadow-black/10 dark:shadow-black/40 ring-1 ring-gray-200/80 dark:ring-white/[0.08] z-50 overflow-hidden">
                  <!-- Header -->
